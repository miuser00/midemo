...
namespace ESP8266_COMReader
{
    public partial class Form1 : Form
    {
        ...
        private void btn_ReadIDMM_Click(object sender, EventArgs e)
        {
            ...
            {
                txt_rsv.Text = "";
                txt_ID.Text = RunCMD("ID:");
                txt_MM.Text = RunCMD("MM:");
            }else
            {
                txt_ID.Text = "";
                txt_MM.Text = "";
            ...
            for (int i = 0; i < 30; i++)
            {
                ...
                try
                {
                    if (txt_rsv.Text != "")
                    {
                        ...
                        int start = -1;
                        start = rsv.IndexOf(cmd, 0);
                        if (start == -1 ) continue;
                        int end = rsv.IndexOf("\n", start);
                        if (end == -1) continue;
                        ret = rsv.Substring(start + cmd.Length, end - start - cmd.Length).Trim();
                        break;
                    }
        ...
        {
            Font titleFont = new Font("宋体", 24, System.Drawing.FontStyle.Bold);//标题字体           
            Font fntTxt = new Font("宋体", 18, System.Drawing.FontStyle.Bold);//正文文字         
            ...
            try
            {
                ...
                g.DrawImage(bitmap, (-20 + XMargin) * XRatio, (20 + YMargin) * YRatio, bitmap.Width * XRatio, bitmap.Height * YRatio);

                StringFormat sf = new StringFormat();

                sf.Alignment = StringAlignment.Near;
                sf.LineAlignment = StringAlignment.Near;
                g.DrawString("扫码加群：", titleFont, brush, new Rectangle((int)((5 + XMargin) * XRatio), (int)((10 + YMargin) * YRatio), (int)(300 * XRatio), (int)(40 * YRatio)), sf);
                //g.DrawString("", fntTxt, brush, new Rectangle((int)((20 + XMargin) * XRatio), (int)((40 + YMargin) * YRatio), (int)(200 * XRatio), (int)(40 * YRatio)), sf);
                g.DrawString("970858559", fntTxt, brush, new Rectangle((int)((40 + XMargin) * XRatio), (int)((255 + YMargin) * YRatio), (int)(200 * XRatio), (int)(40 * YRatio)), sf);

                Bitmap bmp = new Bitmap(pic_label.Image);
                bmp.RotateFlip(RotateFlipType.Rotate90FlipNone);
                bmp.Save(Application.StartupPath+"\\"+txt_MM.Text + ".png");
        ...
        {
            //有图像被打印
            if (System.IO.File.Exists(Application.StartupPath+"\\"+txt_MM.Text+".png"))
            {
                System.Diagnostics.Process.Start("LabelPrinter.exe", txt_MM.Text + ".png" + " " + "Gprinter");
            }
        }
